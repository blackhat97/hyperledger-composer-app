...
URLS="http://companya.twbuddy.com:6001/alice http://companya.twbuddy.com:6001/bob http://companya.twbuddy.com:8080 http://companya.twbuddy.com:3000/explorer/"
case "$(uname)" in
"Darwin") open ${URLS}
          ;;
"Linux")  if [ -n "$BROWSER" ] ; then
	       	        $BROWSER http://companya.twbuddy.com:6001/alice http://companya.twbuddy.com:6001/bob http://companya.twbuddy.com:8080 http://companya.twbuddy.com:3000/explorer/
                  ...
                  for URL in ${URLS} ; do
	                ...
	                gnome-open http://companya.twbuddy.com:6001/alice http://companya.twbuddy.com:6001/bob http://companya.twbuddy.com:8080 http://companya.twbuddy.com:3000/explorer/
	        else
    	            echo "Could not detect web browser to use - please launch Application and Composer Playground URL using your chosen browser ie: <browser executable name> http://companya.twbuddy.com:8080 or set your BROWSER variable to the browser launcher in your PATH"
	        fi
          ;;
